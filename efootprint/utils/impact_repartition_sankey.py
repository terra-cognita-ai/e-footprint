...
class ImpactRepartitionSankey:
    ...
    def build(self):
        ...
        self._assign_columns_and_insert_spacers()
        self._aggregate_small_nodes_by_column()

    def _assign_columns_and_insert_spacers(self):
    ...
    def _aggregate_small_nodes_by_column_once(self):
        ...
        original_spacer_nodes = set(self._spacer_nodes)
        original_spacer_original_source = dict(self._spacer_original_source)
        ...
        for old_idx, label in enumerate(original_full_labels):
            ...
            if old_idx in original_spacer_nodes:
                self._spacer_nodes.add(new_idx)
        ...
        for old_idx, new_idx in old_to_new_indices.items():
            if old_idx in original_spacer_original_source:
                original_src = original_spacer_original_source[old_idx]
                if original_src in old_to_new_indices:
                    self._spacer_original_source[new_idx] = old_to_new_indices[original_src]
